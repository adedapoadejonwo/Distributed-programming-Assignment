...
class GraphicsPanel extends JPanel implements ActionListener, KeyListener
{
	...
	int timerSpinRate = 100; //In milliseconds
        ...
        {
            if(Task3.assignedCar == 1)
            {
                return String.valueOf(Task3.assignedCar) + " " +String.valueOf(car1Speed) + " " + car1SpriteIndex
                    + " " + car1Position.width + " " + car1Position.height;
            }
            else
            {
                return String.valueOf(Task3.assignedCar) + " " +String.valueOf(car2Speed) + " " + car2SpriteIndex
                    + " " + car2Position.width + " " + car2Position.height;
            }
	...
	public GraphicsPanel() 
	{
        ...
        public void SetChanges(int[] changes)
        {
              ...
              {
                  car1Speed = changes[1];
                  car1SpriteIndex = changes[2];
                  car1Position.width = changes[3];
                  car1Position.height = changes[4];
              }
              else
              {
                  car2Speed = changes[1];
                  car2SpriteIndex = changes[2];
                  car2Position.width = changes[3];
                  car2Position.height = changes[4];
              }
        }
    ...
    public void keyPressed(KeyEvent e) 
    {
            try {
                ...
                if(Task3.assignedCar == 1)
                {
                    if(e.getKeyCode() == KeyEvent.VK_UP && car1Speed < 10) car1Speed++;
                    if(e.getKeyCode() == KeyEvent.VK_DOWN && car1Speed > 0) car1Speed--;
